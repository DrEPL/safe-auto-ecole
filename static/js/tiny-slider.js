        ...
        if (Ae)
          ...
          for (
            ...
            e +=
              ...
              '"></button>';
          (e =
            '<div class="tns-nav mt-8" aria-label="Carousel Pagination">' +
            e +
            "</div>"),
      ...
      oe &&
        (xe ||
          ...
          (T.insertAdjacentHTML(
            ...
            '<div class="tns-controls d-flex mt-8 justify-evently" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' +
              Yt +
              '">' +
              pt[0] +
